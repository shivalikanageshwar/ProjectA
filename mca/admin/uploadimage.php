...
if($_SERVER['REQUEST_METHOD']=="POST")
{
   ...
   $ins="insert into uploadimage(name,photo,datetime)
         ...
         <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <!-- Begin Page Content -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">uploadimage</h1>
<div class="row">
    <div class="col-md-12">
                                ...
                                <table class="table table-bordered" id="datatable" style="width=100%">
                                    ...
                                    <tbody>
                                        ...
                                        while($row=mysqli_fetch_array($status1))
                                        {
                                            ...
                                            <td>$id</td>
                                            <td>$name</td>
                                            <td><img src='uploadimages/$photo' width='50' hight='50'></td>
                                            <td>$datetime</td>
                                            <td><a href='uploadimagedelete.php?id=$id'><i class='fas fa-fw fa-trash'></i></a></td>
                                            <td><a href='#.php?id=$id'><i class='bi bi-pencil-square'></i></a></td>
                                        </tr>";
                                        }
                                        ?>
                                    </tbody>
