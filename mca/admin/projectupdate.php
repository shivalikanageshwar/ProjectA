...
if($_SERVER['REQUEST_METHOD']=="POST")
{
   ...
   move_uploaded_file($_FILES['photo']['tmp_name'],"pimages/$photo");
   $update="update project set name='$fname',status='$status',description='$description',photo='$photo',datetime=now() where id='$id'";
  // echo $update;
...
<head>
    ...
    <title>swagraha pvt,limited constrution. -servicesupdate</title>
...
<div class="row">
   ...
   <div class="col-sm-6">
   <input class="form-check-input" type="radio"<?php if($status=="0") { ?> checked  <?php } ?>value="0" name="status" id="flexRadioDefault1">
    Block<br>
   <input class="form-check-input" type="radio"<?php if($status=="1") {?> checked  <?php } ?>value="1" name="status" id="flexRadioDefault2" >
  Active
  </div>
  </div>
 <div class="form-group row">
                                ...
                                <table class="table table-bordered" id="datatable" style="width:100%">
                                    ...
                                    <?php
                                        ...
                                        while($row=mysqli_fetch_array($status1))
                                        {
                                            ...
                                            <td>$status</td>
                                            <td>$description</td>
                                            <td><img src='pimages/$photo' width='50' hight='50'></td>
                                            <td>$datetime</td>
                                            <td><a href='projectdelete.php?id=$id'><i class='fas fa-fw fa-trash'></i></a></td>
                                            <td><a href='projectupdate.php?id=$id'><i class='bi bi-pencil-square'></i></a></td>
                                        </tr>";
                                        }
                                        ?>
                                    </tbody>
