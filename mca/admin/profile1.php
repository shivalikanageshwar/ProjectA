...
if($_SERVER['REQUEST_METHOD']=="POST")
{
   ...
   $ins="insert into profile(name,email,contactno,password,photo,datetime)
values('$name','$email','$contactno','$password','$photo',now())";
                                ...
                                <table class="table table-bordered" id="datatable" style="width=100%">
                                    ...
                                    <tbody>
                                        ...
                                        while($row=mysqli_fetch_array($status1))
                                        {
                                            ...
                                            <td>$contactno</td>
                                            <td>$password</td>
                                            <td><img src='upimages/$photo' width='50' hight='50'></td>
                                            <td>$datetime</td>
                                            <td><a href='profiledelete.php?id=$id'><i class='fas fa-fw fa-trash'></i></a></td>
                                            <td><a href='profileupdate.php?id=$id'><i class='bi bi-pencil-square'></i></a></td>
                                        </tr>";
                                        }
                                        ?>
                                    </tbody>
