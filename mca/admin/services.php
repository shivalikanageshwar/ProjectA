...
if($_SERVER['REQUEST_METHOD']=="POST")
{
   ...
   $ins="insert into services(name,status,description,photo,datetime)
...
<head>
    ...
    <title>swagraha pvt,limited constrution. -services</title>
...
<div class="row">
    ...
    <form  action=""method="post" enctype='multipart/form-data'>
                                <div class="form-group row">
                                    <div class="col-sm-6 ">
                                        <input type="text" onkeypress="return isAlpha(event)" name="name" class="form-control form-control-user" id="examplename"placeholder="name">      
                                         </div>
                                         <div class="col-sm-6">
                                <input class="form-check-input"name="status" type="radio"value="0" name="block" id="flexRadioDefault1">
                                 Block<br>
                                <input class="form-check-input"name="status" type="radio" value="1"name="active" id="flexRadioDefault2" checked>
                                 Active
                                </div>
                                </div>
                                <div class="form-group row">
