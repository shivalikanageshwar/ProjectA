...
if($_SERVER['REQUEST_METHOD']=="POST")
{
   ...
   $update="update blogs set name='$fname',status='$status',description='$description',photo='$photo',datetime=now() where id='$id'";
  // echo $update;
...
<head>
    ...
    <title>swagraha pvt,limited constrution. -blogsupdate</title>
    ...
    <div class="col-md-12">
     <div class="form-group row">
       <div class="col-sm-6 ">
        ...
        <input type="text" name="datetime" value="<?php echo $datetime?>" class="form-control" id="formGroupExampleInput" placeholder="datetime">
